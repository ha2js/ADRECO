<template>
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        <sidebar-link to="/dashboard" :name="$t('sidebar.dashboard')" icon="tim-icons icon-bank"/>
        <sidebar-link to="/feedback1" :name="$t('sidebar.feedback1')" icon="tim-icons icon-chart-bar-32"/>
        <sidebar-link to="/feedback2" :name="$t('sidebar.feedback2')" icon="tim-icons icon-chart-pie-36"/>
        <sidebar-link to="/feedback3" :name="$t('sidebar.feedback3')" icon="tim-icons icon-chart-pie-36"/>
